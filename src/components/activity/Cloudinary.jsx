...
const Cloudinary = () => {
    ...
    const preset_name = "imgsmanagersync";                         //16 Pegamos el "name" rescatado en el punto 24
    const cloud_name = "dw91gh7jr"                          //16.2 Pegamos el cloud_name rescatado en punto 20
